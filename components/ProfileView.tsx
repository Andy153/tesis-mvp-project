        ...
        <div className="panel" style={{ padding: 16 }}>
          ...
          <div className="field">
            ...
            <div className="segmented-control">
              <button
                type="button"
                className={`segmented-option${profile.theme !== 'dark' ? ' active' : ''}`}
                onClick={() => setProfile((p) => ({ ...p, theme: 'light' as ThemeMode, updatedAt: new Date().toISOString() }))}
                title="Claro"
              >
              ...
              <button
                type="button"
                className={`segmented-option${profile.theme === 'dark' ? ' active' : ''}`}
                onClick={() => setProfile((p) => ({ ...p, theme: 'dark' as ThemeMode, updatedAt: new Date().toISOString() }))}
                title="Oscuro"
              >
