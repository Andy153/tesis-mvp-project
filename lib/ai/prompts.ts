...
- cobertura.numero_afiliado (regla práctica): suele ser un número LARGO de 16 a 20 dígitos (en Swiss Medical típicamente 18 o 19). Buscalo cerca de las etiquetas "Número", "Nº", "N°", "Nro", "Credencial", "N° de Credencial", "Nº de Credencial", "Número de Credencial", "Número de Afiliado", "Afiliado Nº", o inmediatamente DEBAJO/AL LADO del campo "Plan", "Prepaga", "Cobertura" o "Obra Social". Devolvelo como STRING manteniendo TODOS los dígitos exactos (no uses notación numérica: puede tener ceros al inicio y supera precisión de int). NO lo confundas con: DNI (7-8 dígitos), nro_cirugia (≤6 dígitos), matrícula (4-6 dígitos), teléfono, código postal, fecha (DD/MM/YYYY) o nro de historia clínica (≤8 dígitos típico). Si en el documento no hay ningún número de 16+ dígitos en ese contexto, devolvé null. NO inventes.
...
- cobertura.numero_afiliado (regla práctica): suele ser un número LARGO de 16 a 20 dígitos (en Swiss Medical típicamente 18 o 19). Buscalo cerca de las etiquetas "Número", "Nº", "N°", "Nro", "Credencial", "N° de Credencial", "Nº de Credencial", "Número de Credencial", "Número de Afiliado", "Afiliado Nº", o inmediatamente DEBAJO/AL LADO del campo "Plan", "Prepaga", "Cobertura" o "Obra Social". Devolvelo como STRING manteniendo TODOS los dígitos exactos (no uses notación numérica: puede tener ceros al inicio y supera precisión de int). NO lo confundas con: DNI (7-8 dígitos), nro de autorización, matrícula (4-6 dígitos), teléfono, código postal, fecha (DD/MM/YYYY). Si no hay ningún número de 16+ dígitos en ese contexto, devolvé null.
- DNI debe tener 7-8 dígitos. Si ves un número más corto, probablemente es Nº de HC, no DNI.
- Si ves 00/00/0000 como fecha, trátalo como null.
