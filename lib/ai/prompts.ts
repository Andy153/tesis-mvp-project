...
- cobertura.numero_afiliado (Swiss Medical): si la prepaga es SWISS MEDICAL, el número de afiliado/credencial suele ser un número LARGO de 18 o 19 dígitos. Aparece cerca de las etiquetas "Número", "N° de Credencial", "N° Credencial", "Credencial", o inmediatamente debajo del campo "Plan" / "Prepaga". NO confundirlo con DNI (7-8 dígitos), HC, ni con números de teléfono. Si ves un número de 18-19 dígitos cerca de esos rótulos, devolvelo COMPLETO como string (sin espacios, sin guiones). Si no hay credencial visible, devolvé null.
- cobertura.numero_afiliado (otras prepagas): para OSDE/Galeno/Medifé/Medicus el formato puede variar (6 a 20 dígitos). Buscá cerca de "Afiliado", "N° Afiliado", "Socio", "N° Socio" o "Credencial". Devolvé el número COMPLETO como string, sin separadores.
...
- cobertura.numero_afiliado (Swiss Medical): si la prepaga es SWISS MEDICAL, el número de afiliado/credencial suele ser un número LARGO de 18 o 19 dígitos. Aparece cerca de las etiquetas "Número", "N° de Credencial", "N° Credencial", "Credencial", o inmediatamente debajo del campo "Plan" / "Prepaga". NO confundirlo con DNI (7-8 dígitos), HC, ni con números de teléfono. Devolvé el número COMPLETO como string, sin espacios ni guiones.
- DNI debe tener 7-8 dígitos. Si ves un número más corto, probablemente es Nº de HC, no DNI.
- Si ves 00/00/0000 como fecha, trátalo como null.
